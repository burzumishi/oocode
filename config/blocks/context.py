...
DEFAULTS = {
    ...
    "highWater":            0.70,   # fracción para disparo de pre-compactación en background
    "toolMaxChars":         3000,   # chars máximos por tool result tras 2ª pasada de compactación
    "compactTarget":        0.50,   # fracción objetivo TRAS compactar: la 2ª pasada trunca hasta bajar de aquí
    "ctxMode":              "mini",  # contexto del workspace al arrancar: "mini" | "full" (equivale a /ctx)
    "planApproval":         False   # plan-mode al arrancar: pide aprobación de planes antes de ejecutar (/plan)
}
